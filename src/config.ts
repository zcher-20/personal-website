...
export const workPageContent: WorkPageContent = {
  ...
  items: [
    ...
    },
    {
      ...
      date: "Jul 2026",
      description: "Conducting AI/ML research as part of a competitive remote internship, applying machine learning methods to structured research problems under faculty supervision.",
    },
    {
      title: "Career Fellow — Tech / SWE Track",
      company: { name: "SEO (Sponsors for Educational Opportunity)", image: "/seo.jpg", url: "https://seofellows.org" },
      date: "2026 - Present",
    ...
    },
    {
      ...
      company: { name: "Columbia General Studies Business Society", image: "/columbia.webp", url: "https://www.columbia.edu" },
    ...
    },
    {
      ...
      company: { name: "Cornell University — Hybrid Body Lab", image: "/cornell.webp", url: "https://cornell.edu" },
      date: "Mar 2026",

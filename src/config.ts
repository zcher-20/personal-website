  ...
  projects: [
    {
      ...
      tags: ["Agentic AI", "RAG", "Document Intelligence", "Python"],
      skills: ["System Architecture", "Rapid Prototyping", "Prompt Engineering", "API Integration", "User Research", "Technical Scoping"],
      learnings: "Prototyping and researching core agent capabilities on a small team, from document ingestion to citation-grounded Q&A.",
      focus: ["Agent architecture & permissions design", "Document search, summarization & citation", "Conflict detection across sources", "Human-in-the-loop approval workflows"],
    ...
    },
    {
      ...
      skills: ["Data Pipeline Design", "Geospatial Analysis", "Model Evaluation", "Research Methodology"],
    ...
    },
    {
      ...
      skills: ["Multi-Agent Orchestration", "System Design", "Evaluation & Synthesis", "Rapid Prototyping"],
    ...
    },
    {
      ...
      skills: ["Hardware Prototyping", "Human-Centered Design", "Cross-Disciplinary Research", "User Testing"],
    ...
    },
    {
      ...
      skills: ["Model Architecture Design", "Benchmarking & Experimentation", "Parameter Optimization", "Technical Writing"],
    ...
    },
    {
      ...
      skills: ["Hardware Benchmarking", "Experiment Design", "Statistical Analysis", "Scientific Publication"],
    ...
    },
    {
      ...
      skills: ["Literature Synthesis", "Taxonomy Design", "Academic Writing", "Cross-Paper Analysis"],
